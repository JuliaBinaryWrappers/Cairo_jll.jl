# `Cairo_jll.jl` (v1.18.2+1)

[![deps](https://juliahub.com/docs/Cairo_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Cairo_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/d3c90a72f0234ad2b35d9d81161bcce31bc86fcf/C/Cairo/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://gitlab.freedesktop.org/cairo/cairo.git (revision: `b9eed915f9a67380e7ef9d8746656455c43f67e2`)
