# `Cairo_jll.jl` (v1.18.2+0)

[![deps](https://juliahub.com/docs/Cairo_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Cairo_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/411b1299587180d80a01fe2a4b9f05554102f236/C/Cairo/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://gitlab.freedesktop.org/cairo/cairo.git (revision: `200441e6855854eb4dbf338e44d67b00ababe07f`)
